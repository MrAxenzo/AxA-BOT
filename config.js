...
module.exports = {
    ...
    SESSION: process.env.AXA_CODE === undefined ? '' : process.env.AXA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ᴀxᴀ ʙᴏᴛ' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'MrAxenzo' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'AxA-BOT' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/NCf11jt.jpeg' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/axemortalff/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '919847475524,0' : process.env.SUDO,
    DEBUG: DEBUG,
